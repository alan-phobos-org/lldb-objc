...
def validate_inspect_shows_ivars():
    ...
    def validator(output):
        ...
        return False, (
            f"Missing instance variables section\n"
            f"    Expected: 'Instance Variables' section\n"
...
def validate_inspect_error_nil_address():
    ...
    def validator(output):
        ...
        return False, (
            f"Should report error for nil address\n    Expected: Error message with 'nil'\n    Actual: {output[:200]}"
        )
...
def validate_inspect_shows_hierarchy():
    ...
    def validator(output):
        ...
        return False, (
            f"Expected class hierarchy or valid output\n"
...
def main():
    ...
    objc_instance_path = os.path.join(PROJECT_ROOT, "scripts", "objc_instance.py")
