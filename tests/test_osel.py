    ...
    def validator(output):
        if "Instance methods" in output and "Class methods" in output:
            ...
            if total_match:
                ...
                return False, (
                    f"Expected >10 methods, got {count}\n"
...
def validate_wildcard_pattern():
    ...
    def validator(output):
        ...
        return False, (
            f"Unexpected output for wildcard pattern\n"
...
def validate_single_char_wildcard():
    ...
    def validator(output):
        ...
        return False, (
            f"Unexpected output for single-char wildcard\n"
...
def validate_case_insensitive():
    ...
    def validator(output):
        ...
        return False, (
            f"Unexpected output for case-insensitive test\n"
...
def validate_invalid_class():
    ...
    def validator(output):
        ...
        return False, (
            f"Should report error for non-existent class\n"
...
def validate_minimal_class():
    ...
    def validator(output):
        ...
        return False, (
            f"Unexpected output for minimal class\n"
...
def validate_multipart_selector():
    ...
    def validator(output):
        ...
        return False, (
            f"No multi-part selectors found\n"
...
def validate_selector_address_format():
    ...
    def validator(output):
        ...
        return False, (
            f"Address not found on method line\n"
...
def validate_instance_only_flag():
    ...
    def validator(output):
        ...
        return False, (
            f"Expected only instance methods\n"
...
def validate_instance_flag_with_pattern():
    ...
    def validator(output):
        ...
        return False, (
            f"Unexpected output for --instance with pattern\n"
...
def validate_class_flag_with_pattern():
    ...
    def validator(output):
        ...
        return False, (
            f"Unexpected output for --class with pattern\n"
...
def get_test_specs():
    ...
    return [
        # Basic functionality
        ("List all methods: NSString", ["osel NSString"], validate_list_all_methods()),
        (
            "Instance method prefix: -",
            ["osel NSString"],
            validate_instance_method_prefix(),
        ),
        ("Class method prefix: +", ["osel NSDate"], validate_class_method_prefix()),
        ("Class pointer display", ["osel NSObject"], validate_class_pointer()),
        # Pattern matching
        (
        ...
        ("Error: no class provided", ["osel"], validate_no_class()),
        # Edge cases
        ("Root class: NSObject", ["osel NSObject"], validate_root_class()),
        ("Minimal class: NSProxy", ["osel NSProxy"], validate_minimal_class()),
        ("Sorted method output", ["osel NSString"], validate_sorted_output()),
        (
        ...
        ("Flag: --instance", ["osel --instance NSDate"], validate_instance_only_flag()),
        ("Flag: --class", ["osel --class NSDate"], validate_class_only_flag()),
        (
